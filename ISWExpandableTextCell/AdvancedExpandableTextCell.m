...
- (SZTextView*) textView
{
    if (_textView == NULL) {
        ...
        cellFrame.size.width = cellFrame.size.width - (2 * kMargin);
        cellFrame.origin.x   = cellFrame.origin.x + kMargin;
        ...
        if (_isw_placeholderTextColor) {
            _textView.placeholderTextColor = _isw_placeholderTextColor;
        }
